...
public class AISpear : MonoBehaviour, IHitboxResponder
{
    ...
    void Update()
    {
        ...
        if (entity.IsAlive())
        {
            ...
            /*float armAngle = Mathf.Atan2(distanceToTarget.y * transform.parent.localScale.x, distanceToTarget.x * transform.parent.localScale.x);
            transform.eulerAngles = new Vector3(0.0f, 0.0f, armAngle * Mathf.Rad2Deg);*/
